...
public class NewsListFragment extends ListFragment implements Constants {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		/*AsyncTask<Integer, Integer, ArrayList<NewsStory>> async = */
		new FeedRetriever(getActivity(), this).execute(type);
		/*try {
			na.addAll(async.get());
	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		...
		new LinkClickNotifier(getActivity(), NewsListFragment.this).execute(""
				+ type, ns.news_title, ns.news_summary);
